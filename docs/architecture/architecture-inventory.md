...
> reference/evidence/college/content domains in the old Phase A–G scheme. Practice-management
> sequencing is now `docs/planning/revision-2026-09.md`'s Stage 0–4 gates. The
> discipline/condition/therapy/references/directory/content domains sketched below have their
> direction decided (not scheduled) in `docs/planning/future-scope-2026-09.md` — that document
> corrects one thing in the sketch below: **"herb" as a standalone table was rejected** — herbal
