...
**Current snapshot (2026-09-24):** 14 backend modules, 131 module endpoints, 34 tables, 132 frontend source files across 11 route groups (10 dashboard route groups + login). See `docs/status/current.md` for the authoritative breakdown.
