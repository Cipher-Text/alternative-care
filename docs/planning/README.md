...
- Module endpoints: 135 total (+ `/`, `/health`, `/metrics`) — `POST /auth/login-2fa`, 4 password-reset/email-verification endpoints, and 2 Google Sign-In endpoints (`/auth/google`, `/auth/google/register`) all added 2026-09-23 (see revision-2026-09.md Stage 0/1)
